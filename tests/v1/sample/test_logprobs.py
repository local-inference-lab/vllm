...
def test_all_logprobs(example_prompts):
    """Engine should return all vocabulary sample logprobs.
    ...
    with VllmRunner(
        ...
        sampling_params_logprobs_all = SamplingParams(max_tokens=5, logprobs=-1)
        ...
        for i in range(len(results_logprobs_all)):
            ...
            assert results_logprobs_all[i].prompt_logprobs is None
