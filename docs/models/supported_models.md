...
| `MiMoV2OmniForCausalLM` | MiMo-V2.5-Omni, MiMo-V2.6-Flash-RL | T + I<sup>E+</sup> + V<sup>E+</sup> + A<sup>+</sup> | `XiaomiMiMo/MiMo-V2.5-Omni`, [`XiaomiMiMo/MiMo-V2.6-Flash-RL`](mimo_v26_flash_rl.md) | | ✅︎ |
