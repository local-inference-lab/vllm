...
class EngramConfig:
    ...
    table_memory: Literal["device", "disk"] = "device"
    """Native V4.1 table storage: resident CUDA rows or SSD io_uring staging.
    This selector is independent of the legacy cpu_offload option."""
