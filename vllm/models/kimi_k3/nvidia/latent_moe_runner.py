...
class LatentMoERunner(MoERunner):
    ...
    The base path supports replicated and row-parallel up-projections. A
    row-parallel projection combines routed and shared rank-local partials
    before one final all-reduce.
    """
